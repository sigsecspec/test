...
const HomePage: React.FC<HomePageProps> = ({ onOpenLoginModal }) => {
    ...
    const statList = [ { value: "500+", label: "Certified Guards" }, { value: "1,200+", label: "Missions Completed" }, { value: "98%", label: "Client Satisfaction" }, { value: "24/7", label: "Support Available" } ];
    const levelList = [
      { title: "Level 1 - Basic", desc: "Essential security guard with standard equipment" }, { title: "Level 2 - Enhanced", desc: "Basic equipment plus pepper spray" },
      { title: "Level 3 - Advanced", desc: "Pepper spray plus taser" }, { title: "Level 4 - Professional", desc: "Pepper spray, taser, and baton" },
      { title: "Level 5 - Executive", desc: "Full equipment including firearm certification" }, { title: "All Levels Include", desc: "Flashlight, cuffs, first aid (with certifications)" },
    ];
