...
export const TrophyIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path fillRule="evenodd" d="M5.166 2.377a.75.75 0 0 1 .75 0L7.68 3.55a.75.75 0 0 1 .14 1.284l-1.033.725a.75.75 0 0 1-1.012-.063L4.5 4.123a.75.75 0 0 1 .666-1.746ZM18.834 2.377a.75.75 0 0 0-.75 0L16.32 3.55a.75.75 0 0 0-.14 1.284l1.033.725a.75.75 0 0 0 1.012-.063l1.273-1.373a.75.75 0 0 0-.666-1.746ZM11.25 4.5A.75.75 0 0 1 12 5.25v1.5a.75.75 0 0 1-1.5 0v-1.5A.75.75 0 0 1 11.25 4.5Z" clipRule="evenodd" />
        <path d="M6.31 9.47a.75.75 0 0 1 .94-.47l.812.271a.75.75 0 0 0 .94-.47l.812-1.354a.75.75 0 0 1 .63-.354h2.992a.75.75 0 0 1 .63.354l.812 1.354a.75.75 0 0 0 .94.47l.812-.271a.75.75 0 0 1 .94.47l.812 1.354a.75.75 0 0 1 0 .75l-.812 1.354a.75.75 0 0 1-.94.47l-.812-.271a.75.75 0 0 0-.94.47l-.812 1.354a.75.75 0 0 1-.63.354H9.78a.75.75 0 0 1-.63-.354l-.812-1.354a.75.75 0 0 0-.94-.47l-.812.271a.75.75 0 0 1-.94-.47l-.812-1.354a.75.75 0 0 1 0-.75l.812-1.354Z" />
        <path d="M5.25 15.75a.75.75 0 0 1 .75-.75h12a.75.75 0 0 1 0 1.5H6a.75.75 0 0 1-.75-.75Z" />
        <path fillRule="evenodd" d="M8.25 18a.75.75 0 0 1 .75.75v2.25a.75.75 0 0 1-1.5 0v-2.25a.75.75 0 0 1 .75-.75Zm3.75 0a.75.75 0 0 1 .75.75v2.25a.75.75 0 0 1-1.5 0v-2.25a.75.75 0 0 1 .75-.75Zm3.75 0a.75.75 0 0 1 .75.75v2.25a.75.75 0 0 1-1.5 0v-2.25a.75.75 0 0 1 .75-.75Z" clipRule="evenodd" />
    </svg>
);