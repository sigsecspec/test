                    ...
                    return `
                        <div class="bg-[var(--bg-secondary)] p-4 border border-[var(--border-primary)] rounded-lg shadow-sm flex justify-between items-center">
                            ...
                            <div class="text-right">
                                ${prog ? `
                                    <span class="px-3 py-1 text-sm font-semibold rounded-full ${statusColor}">${prog.status}</span>
                                ` : `
                                     <button class="px-4 py-2 bg-[var(--accent-secondary)] text-[var(--accent-primary-text)] font-bold rounded-md hover:bg-[var(--accent-secondary-hover)]">Start Training</button>
                                `}
                            </div>
                        </div>
                    `;
