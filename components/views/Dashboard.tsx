...
import { getApplications, getMissions, getPendingTrainingApprovals, getPendingSiteApprovals, getContracts, getAlerts, getUserTrainingProgress, getClients, User } from '../../database.js';
...
export const DashboardView = ({ user }: DashboardViewProps) => {
    ...
    const StatCard = ({ title, value, icon, color, action, type }: { title: string, value: any, icon: ({ className }: { className?: string; }) => string, color: { bg: string, text: string }, action?: string, type?: string }) => `
