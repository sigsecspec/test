...
import { getActionLog, getUsers, User } from '../../database.js';
import { UserRole } from '../../types.js';
import { Icons } from '../Icons.js';

interface OwnerActionAuditProps {
    user: User;
}

const renderAuditLogTable = (logs: any[], allUsers: User[]) => {
...
const renderAuditLogCards = (logs: any[], allUsers: User[]) => {
    const getUserName = (userId: string) => {
        const user = allUsers.find(u => u.id === userId);
        return user ? `${user.firstName} ${user.lastName}` : 'Unknown';
    };
...
export const OwnerActionAudit = ({ user }: OwnerActionAuditProps) => {
