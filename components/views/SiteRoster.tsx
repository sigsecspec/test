...
const SiteRoster: React.FC<{ user: User }> = () => {
    return (
         <div className="animate-in" style={{ animationDelay: "100ms", opacity: 0, transform: "translateY(10px)" }}>
            <h1 className="text-3xl font-bold text-gray-800 mb-6">Site Roster</h1>
             <div className="bg-white p-6 border rounded-lg shadow-sm">
                <p>This view will display a list of all client sites for management.</p>
